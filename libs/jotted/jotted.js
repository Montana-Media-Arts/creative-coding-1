...
(function (global, factory) {
  ...
  function container() {
    return `\n     <div class="jotted-code">\n        <div class="jotted-nav jotted-nav-item jotted-nav-item-html">\n        <div class="jotted-nav-label" data-jotted-type="html">\n          HTML\n        </div>\n      <div class="jotted-pane jotted-pane-html"></div>\n    </div>\n      <div class="jotted-nav jotted-nav-item jotted-nav-item-css">\n        <div class="jotted-nav-label" data-jotted-type="css">\n          CSS\n        </div>\n      <div class="jotted-pane jotted-pane-css"></div>\n    </div>\n      <div class="jotted-nav jotted-nav-item jotted-nav-item-js">\n        <div class="jotted-nav-label" data-jotted-type="js">\n          JavaScript\n        </div>\n      <div class="jotted-pane jotted-pane-js"></div>\n  </div>\n    </div>\n     <div class="jotted-nav jotted-nav-item jotted-nav-item-result">\n        <div class="jotted-nav-label" data-jotted-type="result">\n          Result\n        </div>\n      </div>\n      <div class="jotted-pane jotted-pane-result displayed_jotted_example"><iframe></iframe></div>\n`;
  }
  ...
  var PluginConsole = function () {
    function PluginConsole(jotted, options) {
      ...
      addClass($pane, 'jotted-nav jotted-nav-item jotted-nav-item-console');
      $pane.innerHTML = '<div class="jotted-nav-label" data-jotted-type="console">JS Console</div> <div class="jotted-pane jotted-pane-console"> \n      <div class="jotted-console-container">\n        <ul class="jotted-console-output"></ul>\n        <form class="jotted-console-input">\n          <input type="text">\n        </form>\n      </div>\n      <button class="jotted-button jotted-console-clear">Clear</button>\n     </div>';
      ...
      jotted.$container.querySelector('.jotted-code').appendChild($pane);
  ...
  var Jotted = function () {
    function Jotted($jottedContainer, opts) {
      ...
      // optionally hide results-pane
      if (options.showResult === false) {
          var $paneSection = this._get('$container').querySelector('.jotted-pane-result');
          if (typeof $paneSection !== 'null') {
              // testEl = $paneSection;
