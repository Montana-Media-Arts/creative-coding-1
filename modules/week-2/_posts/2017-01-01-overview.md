...
Remember if you have issues or problems to utilize the [“GitHub issues forum”](https://github.com/Montana-Media-Arts/120_CreativeCoding/issues) that you responded to last week. You should always first look if anyone has had a similar problem as you are having, if so, add a comment discussing how (if at all) your issue differs. Then start talking with each other about how to fix your problem.
